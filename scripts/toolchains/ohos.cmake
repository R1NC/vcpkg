...
if (DEFINED ENV{OHOS_NDK_HOME})
    ...
    if(DEFINED ENV{DEVECO_SDK_HOME})
        set(OHOS_NDK_HOME "$ENV{DEVECO_SDK_HOME}/default/openharmony/native")
    else ()
        set(OHOS_NDK_HOME "$ENV{ProgramFiles}/Huawei/DevEco Studio/sdk/default/openharmony/native")
    endif ()
endif()

if (NOT EXISTS "${OHOS_NDK_HOME}/build/cmake/ohos.toolchain.cmake")
    message(FATAL_ERROR "Could not find OpenHarmony Native SDK. Searched at OHOS_NDK_HOME environment variable: ${OHOS_NDK_HOME}")
endif()
